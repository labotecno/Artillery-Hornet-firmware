 ...
 */
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  20               // Seconds                       //lab
 ...
 */
   ...
   */
  #define PID_FAN_SCALING                                             //lab
  #if ENABLED(PID_FAN_SCALING)
    #define PID_FAN_SCALING_ALTERNATIVE_DEFINITION                  //lab
...
#define AUTOTEMP
  ...
  #define AUTOTEMP_PROPORTIONAL                                                //lab
 ...
 */
#define USE_CONTROLLER_FAN                                         //lab
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN PC6          // Set a custom pin for the controller fan            //lab
...
//#define LCD_BACKLIGHT_TIMEOUT 30 // (s) Timeout before turning off the backlight
  ...
  #define LCD_INFO_MENU                                                     //lab
  #if ENABLED(LCD_INFO_MENU)
    //#define LCD_PRINTER_INFO_IS_BOOTSCREEN // Show bootscreen(s) instead of Printer Info pages
  #endif

  // BACK menu items keep the highlight at the top
  //#define TURBO_BACK_MENU_ITEM                                              //lab
  ...
  #define LCD_SET_PROGRESS_MANUALLY                                //lab
...
// LCD Print Progress options
    ...
    #define SHOW_REMAINING_TIME         // Display estimated time to completion                         //lab
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY                                            //lab
  ...
  #define SD_REPRINT_LAST_SELECTED_FILE // On print completion open the LCD Menu and select the same file         //lab

  #define AUTO_REPORT_SD_STATUS         // Auto-report media status with 'M27 S<seconds>'                               //lab
   ...
   */
  #define SDCARD_CONNECTION LCD                                  //ab
 ...
 */
  ...
  #define BOOT_MARLIN_LOGO_ANIMATED // Animated Marlin logo. Costs ~3260 (or ~940) bytes of flash.           //lab
 ...
 */
#define BABYSTEPPING                                           //lab
#if ENABLED(BABYSTEPPING)
  //#define INTEGRATED_BABYSTEPPING         // EXPERIMENTAL integration of babystepping into the Stepper ISR
  //#define BABYSTEP_WITHOUT_HOMING
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement).       //lab
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping.              //lab
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28             //lab

  //#define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping                    //lab
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    #define BABYSTEP_ZPROBE_GFX_OVERLAY   // Enable graphical overlay on Z-offset editor         //lab
  #endif
#endif
 ...
 */
#define LIN_ADVANCE                                                                   //lab
#if ENABLED(LIN_ADVANCE)
  //#define EXTRA_LIN_ADVANCE_K // Enable for second linear advance constants
  #define LIN_ADVANCE_K 0    // Unit: mm compression per 1mm/s extruder speed           //lab
  //#define LA_DEBUG            // If enabled, this will generate debug information output over USB.
  #define EXPERIMENTAL_SCURVE // Enable this option to permit S-Curve Acceleration        //lab
 ...
 */
#define MINIMUM_STEPPER_POST_DIR_DELAY 20                                                 //lab
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
#define MINIMUM_STEPPER_PULSE 0                                                  //lab
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
#define MAXIMUM_STEPPER_RATE 5000000                                               //lab
...
#define TX_BUFFER_SIZE 32                                         //lab

// Host Receive Buffer Size
// Without XON/XOFF flow control (see SERIAL_XON_XOFF below) 32 bytes should be enough.
// To use flow control, set this buffer size to at least 1024 bytes.
// :[0, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048]
#define RX_BUFFER_SIZE 128                                             //lab

#if RX_BUFFER_SIZE >= 1024                                              //lab
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     25  // (mm/s) Unload filament feedrate. This can be pretty fast.      //lab
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      650  // (mm) The length of filament for a complete unload.              //lab
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   25  // (mm/s) Load filament feedrate. This can be pretty fast.        //lab
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    570 // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.           //lab
                                                  //   For direct drive, the full length of the nozzle.
  //#define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.
  #define ADVANCED_PAUSE_PURGE_FEEDRATE        3  // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
  #define ADVANCED_PAUSE_PURGE_LENGTH         80  // (mm) Length to extrude after loading.                            //lab
  ...
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change.    //lab                 //lab
  #define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change   //lab

  #define FILAMENT_LOAD_UNLOAD_GCODES           // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.   //lab
 ...
 */
#define AUTO_REPORT_POSITION                                                  //lab
...
#define EXTENDED_CAPABILITIES_REPORT
  ...
  #define M115_GEOMETRY_REPORT                                                      //lab
#endif
...
#define M114_DETAIL         // Use 'M114` for details to check planner calculations                       //lab
//#define M114_REALTIME       // Real current position based on forward kinematics
//#define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

#define REPORT_FAN_CHANGE   // Report the new fan speed when changed by M106 (and others)                 //lab
...
#define MEATPACK_ON_SERIAL_PORT_1                                              //lab
//#define MEATPACK_ON_SERIAL_PORT_2

#define GCODE_CASE_INSENSITIVE  // Accept G-code sent to the firmware in lowercase                   //lab
